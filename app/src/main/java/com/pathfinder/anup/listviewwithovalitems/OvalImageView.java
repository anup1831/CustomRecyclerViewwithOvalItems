...
public class OvalImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private Bitmap getOvalCroppedBitmap(Bitmap bitmap, int radius){
        Bitmap finalBitmap;
        ...
        float rightEndPoint = ((getWidth()/2) + ((getWidth()/2) + getWidth()/4));
        RectF oval = new RectF(leftStartingPoint, 10, rightEndPoint, 70);
